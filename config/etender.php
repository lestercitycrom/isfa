...
return [
    ...
    'search_event_type' => env('ETENDER_SEARCH_EVENT_TYPE', '2'),
    'search_event_status' => env('ETENDER_SEARCH_EVENT_STATUS', '1'),
    ...
    'search_max_detail_check' => (int) env('ETENDER_SEARCH_MAX_DETAIL_CHECK', 250),
];
